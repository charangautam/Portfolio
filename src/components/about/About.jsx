    ...
    return (
        <div className="about">
            ...
            <div className="a-right">
                ...
                <p className="a-sub">
                    I pursued Kinesiology in my undergrad because of an innate drive to empower others to experience the physical, social, and mental wellness benefits associated with healthy living. I’ve always had a passion for technology as it works to enhance lives and open more opportunities around the world.
                </p>
                <p className="a-desc">
                ...
                <p className="a-desc two">
                    On my free time: I love exploring foreign cultures and have travelled to 7 countries so far. You are likely to find me at the gym, soccer field or basketball court. I enjoy watching all types of sports and admire the competitive nature between elite athletes. I am learning more about personal finance and investing.
                </p>
